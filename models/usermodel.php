...
class Usermodel extends Model 
{
    ...
    {     
		...
		$this->_tablelist=$this->_prefix.'user_list';
    }
     ...
     * @return query string
     */
	function getUsersNotSuperadmin($fields=null, $limit=null, $where=null)
	{	
		...
		return $this->db->get($this->_tablelist);
	}
	...
	function searchUser($limit = null, $isSuperAdmin){
